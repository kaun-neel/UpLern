...
<<<<<<< HEAD
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl transform rotate-45"></div>
              </div>
              <div className="w-96 h-96 relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-br from-purple-500 to-pink-500 rounded-3xl transform rotate-12"></div>
                <div className="absolute bottom-0 right-0">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl transform -rotate-12"></div>
                </div>
              </div>
              <div className="absolute -bottom-8 left-1/4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl transform rotate-45"></div>
=======
...
>>>>>>> 117c30fa8015fd276c748e4ca9ae5645df66f8c5
            ...
            <div>
<<<<<<< HEAD
              <span className="inline-block px-4 py-2 bg-blue-50 text-sm rounded-full mb-6">
                About upLern
              </span>
...
<<<<<<< HEAD
          <h2 className="text-3xl font-bold mb-8">We are Certified</h2>
...
<<<<<<< HEAD
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">Partnered with Top Institutions</h4>
                  <p className="text-gray-600">
=======
...
<<<<<<< HEAD
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">Real-World Use Cases</h4>
                  <p className="text-gray-600">
=======
                <div className="w-10 h-10 rounded-full bg-purple-100/80 backdrop-blur-sm flex items-center justify-center">
                  <BookOpen className="w-5 h-5 text-purple-600" />
...
<<<<<<< HEAD
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">Inclusive & Diverse Learning</h4>
                  <p className="text-gray-600">
=======
                <div className="w-10 h-10 rounded-full bg-purple-100/80 backdrop-blur-sm flex items-center justify-center">
                  <GraduationCap className="w-5 h-5 text-purple-600" />
...
<<<<<<< HEAD
          <h2 className="text-3xl font-bold mb-12">How does upLern Works?</h2>
=======
...
<<<<<<< HEAD
              <div key={index} className="bg-white p-8 rounded-3xl shadow-sm">
                ...
                <p className="text-sm text-gray-500 italic">{step.quote}</p>
=======
